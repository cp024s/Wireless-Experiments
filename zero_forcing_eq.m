...
% Generate Channel
h = [0.19 + 0.56j, 0.45 - 1.28j, -0.14 - 0.53j, -0.19 + 0.23j, 0.33 + 0.51j]; % LTE channel
L1 = 1; L2 = 3;
...
q_ZF(L1 + N1 + 1) = 1; % Puts the one in the place corresponding to desired symbol
w_LS = ((H' * H) \ (H')) * q_ZF; % ZF equalizer coefficients using LS estimate
...
grid on;
legend('Equalized data', 'Ideal constellation points');
